...
namespace AgroServicios.Controlador.ControladorStats
{
        class ControladorActualizarProveedor
        {
            ...
            public ControladorActualizarProveedor(VistaActualizarProveedor Vista, int accion, int id, string Name, string phone, string email, string Dui, int marca)
            {
                Objupdate = Vista;
                this.accion = accion;
                ChargeValues(id, Name, Dui, phone, email, marca);
        ...
        public void ChargeValues(int id, string Name, string Dui, string phone, string email, int marca)
            {
                ...
                Objupdate.cmbMarca.SelectedValue = marca;
            }
